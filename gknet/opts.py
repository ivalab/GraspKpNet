...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument(
            "task", default="ctdet", help="dbmctdet | dbmctdet_cornell"
        )
        self.parser.add_argument(
            "--dataset", default="coco", help="cornell | jac_coco_36"
        )
        self.parser.add_argument(
            "--dataset_dir",
            default="./datasets",
        ...
        self.parser.add_argument(
            "--lr_step", type=str, default="20,25", help="drop learning rate by 10."
        )
        self.parser.add_argument(
        ...
        # test
        self.parser.add_argument(
            "--flag_test", action="store_true", help="switch dataset annotations."
        )
        self.parser.add_argument(
        ...
        self.parser.add_argument(
            "--K", type=int, default=100, help="select top K of each heatmap."
        )
        self.parser.add_argument(
            "--num_dets", type=int, default=100, help="max number of output objects."
        )
        self.parser.add_argument(
            "--nms_kernel", type=int, default=3, help="kernel for nms."
        )
        self.parser.add_argument(
            "--ae_threshold",
            type=float,
        ...
        self.parser.add_argument(
            "--visual", action="store_true", help="debug flag for visualization."
        )
        self.parser.add_argument(
            "--keep_res",
            action="store_true",
        ...
        # dbmctdet
        self.parser.add_argument(
            "--regr_loss", default="l1", help="regression loss: sl1 | l1 | l2"
        )
        self.parser.add_argument("--ae_loss", default="ae", help="embedding loss")
        self.parser.add_argument(
            "--pull_weight",
            type=float,
            default=1,
        ...
        self.parser.add_argument(
            "--eval_oracle_tl", action="store_true", help="use ground top-left heatmap."
        )
        self.parser.add_argument(
            "--eval_oracle_bl",
            action="store_true",
        ...
        self.parser.add_argument(
            "--eval_oracle_ct", action="store_true", help="use ground center heatmap."
        )
        self.parser.add_argument(
            "--eval_oracle_ae", action="store_true", help="use ground truth embedding."
        )
    ...
    def parse(self, args=""):
        ...
        opt.num_stacks = (
            int(opt.arch.split("_")[1])
            if opt.arch.split("_")[0] == "hourglass"
            or opt.arch.split("_")[0] == "hourglassnl"
            else 1
        )
    ...
    def init(self, args=""):
        default_dataset_info = {
            "dbmctdet": {
                ...
                "num_classes": 36,
                "mean": [0.711156, 0.709059, 0.197465],
                "std": [0.060364, 0.067899, 0.087001],
                "dataset": "jac_coco_36",
            },
            "dbmctdet_cornell": {
                "default_resolution": [256, 256],
                "num_classes": 18,
                "mean": [0.850092, 0.805317, 0.247344],
                "std": [0.104114, 0.113242, 0.089067],
                "dataset": "cornell",
            },
        }
