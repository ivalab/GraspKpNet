...
class exkp(nn.Module):
    def __init__(
        ...
        #     NLBlockND(cnv_dim, dimension=2) for _ in range(nstack)
        # ])
        self.non_local = NLBlockND(cnv_dim, dimension=2)
...
def get_large_hourglass_nl_net(num_layers, heads, head_conv):
