...
from models.decode import _topk_original
...
class DbCtdetDebugger(BaseDebugger):
  ...
  def forward(self, images):
    with torch.no_grad():
      ...
      detections = {'tl_heatmap':tl, 'br_heatmap':br, 'ct_heatmap':ct,
                    'tl_reg':tl_reg, 'br_reg':br_reg, 'ct_reg':ct_reg,
                    'tl_tag':tl_tag, 'br_tag':br_tag}
