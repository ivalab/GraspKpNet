...
from gknet.utils.kinect_depth_smoother import Denoising_Filter, HoleFilling_Filter
...
def kinect_rgbd_callback(rgb_data, depth_data):
    ...
    try:
        ...
        hf_depth = hole_filter.smooth_image(
            depth_raw[pb_tl[1] : pb_br[1], pb_tl[0] : pb_br[0]] * 1000
        )
